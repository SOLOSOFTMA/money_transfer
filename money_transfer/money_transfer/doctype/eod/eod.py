...
class EOD(Document):
	...
	def insert_Opening_Bal(self):	
		frappe.db.sql("""insert into `tabTransactions Details` (name, creation, modified_by, owner, user_id, currency, posting_date, inflow, description) select concat(name, '-', convert(posting_date,char(10))), posting_date-1, user_id, user_id, user_id, 
